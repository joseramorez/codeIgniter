...
function generar_pwd(field) {
    ...
    document.getElementById(field).className = 'm form-control';
...
function verificar_nombre() {
    ...
    if(username.length > 5) {
        document.getElementById('username').className = 's form-control';
...
function confirmar(username, userid) {
    ...
    function(){ location.href='/users/user/eliminar/' + userid;alertify.success('Ok');});
