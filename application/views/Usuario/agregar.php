    ...
    <input type="hidden" name="usuario_id" value="{usuario_id}">
      ...
      <div class="form-row">
        <div class="form-group col col-md-4">
          ...
          <input type="text" name="nombre" value="{nombre}" class="form-control" placeholder="JUAN" autocomplete="off">
        </div>
        <div class="form-group col col-md-4">
          <label for="">APELLIDO PATERNO</label>
          <input type="text" name="apellido_p" value="{apellido_p}" class="form-control" placeholder="SANCHEZ" autocomplete="off">
        </div>
        <div class="form-group col col-md-4">
          <label for="">APELLIDO MATERNO</label>
          <input type="text" name="apellido_m" value="{apellido_m}" class="form-control" placeholder="HERNANDEZ" autocomplete="off">
        </div>
      </div>
